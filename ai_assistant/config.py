...
# Interval for the background service to attempt autonomous action selection (in seconds)
AUTONOMOUS_ACTION_INTERVAL_SECONDS = int(os.getenv("AUTONOMOUS_ACTION_INTERVAL_SECONDS", 900)) # Default to 15 minutes
