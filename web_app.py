...
# Initialize SocketIO
# Restrict CORS to localhost for security, or configurable via env
cors_origins = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://127.0.0.1:5000,http://localhost:5000').split(',')
